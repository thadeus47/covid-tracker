...
const NewsCard = ({ article: { description, publishedAt, source, title, url, urlToImage }, i , activeArticle}) => {
  ...
  //use useEffect to create references at the start of the application and is called only once to set up the references
  useEffect(() => {
    window.scroll(0, 0);
  ...
  //for scrolling through the articles in a separate useEffect and this is called each time an active article and refs changes
  useEffect(() => {
